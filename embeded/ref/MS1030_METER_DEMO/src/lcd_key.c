...
void Time_Display_up(void)
{
        ...
        LCDdisplay_Number(1,0x20);
        if(((uint8_t)(TimeValue_up_int/100%10))==0)
        {
           LCDdisplay_Number(2,0x00); 
        }
        else
        {
           LCDdisplay_Number(2,LcdNumber1[TimeValue_up_int/100%10]); 
        }
       
        if(((uint8_t)(TimeValue_up_int/10%10))==0)
        {
           LCDdisplay_Number(3,0x00); 
        }
        else
        {
           LCDdisplay_Number(3,LcdNumber1[TimeValue_up_int/10%10]); 
        }
    	LCDdisplay_Number(4,LcdNumber1[TimeValue_up_int%10]);
        LCDdisplay_Number(5,LcdNumber1[TimeValue_up_dec/100000%10]);
        LCDdisplay_Number(6,LcdNumber1[TimeValue_up_dec/10000%10]);
        LCDdisplay_Number(7,LcdNumber1[TimeValue_up_dec/1000%10]);
        LCDdisplay_Number(8,LcdNumber1[TimeValue_up_dec/100%10]);	
	LCDdisplay_Number(9,0x00);
...
void Time_Display_down(void)
{
        ...
        if(((uint8_t)(TimeValue_down_int/100%10))==0)
        {
           LCDdisplay_Number(2,0x00); 
        }
        else
        {
           LCDdisplay_Number(2,LcdNumber1[TimeValue_down_int/100%10]); 
        }
       
        if(((uint8_t)(TimeValue_down_int/10%10))==0)
        {
           LCDdisplay_Number(3,0x00); 
        }
        else
        {
           LCDdisplay_Number(3,LcdNumber1[TimeValue_down_int/10%10]); 
        }
    	LCDdisplay_Number(4,LcdNumber1[TimeValue_down_int%10]);
        LCDdisplay_Number(5,LcdNumber1[TimeValue_down_dec/100000%10]);
        LCDdisplay_Number(6,LcdNumber1[TimeValue_down_dec/10000%10]);
        LCDdisplay_Number(7,LcdNumber1[TimeValue_down_dec/1000%10]);
        LCDdisplay_Number(8,LcdNumber1[TimeValue_down_dec/100%10]);	
	LCDdisplay_Number(9,0x00);
	LCDdisplay_Number(10,0x80);
}
...
void Time_Display_diff(void)
{
        ...
        LCDdisplay_Number(4,LcdNumber1[TimeValue_down_up_dec/100000%10]);
        LCDdisplay_Number(5,LcdNumber1[TimeValue_down_up_dec/10000%10]);
        LCDdisplay_Number(6,LcdNumber1[TimeValue_down_up_dec/1000%10]);
        LCDdisplay_Number(7,LcdNumber1[TimeValue_down_up_dec/100%10]|0x01);
        LCDdisplay_Number(8,LcdNumber1[TimeValue_down_up_dec/10%10]);	
	LCDdisplay_Number(9,0x00);
	LCDdisplay_Number(10,0x00);
}
...
void Blue_Display(void)
{
        ...
        LCDdisplay_Number(5,LcdNumber1[temper_bule/100%10]);//百位
...
void Red_Display(void)
{
        ...
        LCDdisplay_Number(5,LcdNumber1[temper_red/100%10]);
