...
uint32_t time_up_result;
uint32_t time_down_result;
uint32_t time_up_down_result;

uint32_t time_check_temp=0;

uint8_t  SPI_check_temp;
uint16_t Result_PW_First;
uint16_t Result_PW_STOP1;
